...
(function ($) {
  window.addEventListener("DOMContentLoaded", function () {
    ...
    var phoneValidatorArgs = {
      ...
      ...orderValidator.validateRulesByCountry[
        window.app.currentOffer.country.code
      ],
    };
    ...
    orderValidator.addRule(
      "phone",
      orderValidator.errorPhoneField,
      "phone",
      phoneValidatorArgs
    );
    ...
    orderValidator.addRule(
      "other[email]",
      orderValidator.errorEmailField,
      "email"
    );
  ...
  $(document).on(
    "keyup keydown click input",
    "form:not(.novalidate, .notorder)",
    function (e) {
  ...
  function fixForm(form) {
    ...
    if (form.find("select[name=offer]").length) {
      $(form)
        .find("[name=country]")
        .val(app.currentOffer && app.currentOffer.country.code);
    } else {
